...
import { Cluster } from '@/shared/model/cluster.model';
...
describe('Service Tests', () => {
  describe('Cluster Service', () => {
    ...
    describe('Service methods', () => {
      ...
      it('should not create a Cluster', async () => {
      ...
      it('should not update a Cluster', async () => {
      ...
      it('should not return a list of Cluster', async () => {
        mockedAxios.get.mockReturnValue(Promise.reject(error));
      ...
      it('should not delete a Cluster', async () => {
