...
import org.kafmin.config.KafkaProperties;
...
class KafminKafkaResourceIT {
    ...
    void setup() {
        ...
        KafminKafkaResource kafkaResource = new KafminKafkaResource(kafkaProperties);
...
//    @Test
    ...
    void consumesMessages() throws Exception {
        ...
        MvcResult mvcResult = restMockMvc.perform(get("/api/kafmin-kafka/consume?topic=topic-consume"))
            .andExpect(status().isOk())
