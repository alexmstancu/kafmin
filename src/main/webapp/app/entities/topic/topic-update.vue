        ...
        <dl class="row jh-entity-details">
          ...
          <dd>
            <div v-if="topic.cluster">
              <router-link
                :to="{name: 'ClusterView', params: {clusterId: topic.cluster.id}}"
              >{{topic.cluster.name}} ({{topic.cluster.clusterId}})</router-link>
            </div>
          </dd>
        </dl>
      </div>
      ...
      <form name="editForm" role="form" novalidate v-on:submit.prevent="save()">
          ...
          <div>
            <div class="form-group">
              ...
              <input
                ...
                name="name"
                id="topic-name"
                :class="{'valid': !$v.topic.name.$invalid, 'invalid': $v.topic.name.$invalid }"
                v-model="$v.topic.name.$model"
              />
            </div>
            <div class="form-group">
              ...
              <input
                class="form-control"
                name="numPartitions"
                id="topic-numPartitions"
                :class="{'valid': !$v.topic.numPartitions.$invalid, 'invalid': $v.topic.numPartitions.$invalid }"
                v-model.number="$v.topic.numPartitions.$model"
              />
            </div>
            ...
            <div class="form-group">
              ...
              <input
                ...
                id="topic-replicationFactor"
                :class="{'valid': !$v.topic.replicationFactor.$invalid, 'invalid': $v.topic.replicationFactor.$invalid }"
                v-model.number="$v.topic.replicationFactor.$model"
              />
            </div>
          </div>
        </div>
        <div>
          ...
          <button
            type="submit"
            id="save-entity"
            :disabled="$v.topic.$invalid || isSaving"
